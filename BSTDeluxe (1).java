 ...
 * Data: 19/06/2022
 *
 * Baseado em código fornecido em aula e disponível no sandbox, as funções alteradas
 * foram: Node, put e delete.
 *
...
public class BSTDeluxe<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        ...
        private int height;
        private int ipl; // ^^ Nome auto-explicativo
    ...
    private Node put(Node x, Key key, Value val) {
        ...
        // ^ Duas linhas adicionais para o IPL e height ( Duas linhas iguais aqui e no delete)
        return x;
    }
    ...
    private Node delete(Node x, Key key) {
        ...
        x.ipl = ipl(x.left) + ipl(x.right) + (x.size - 1);
        x.height = 1 + Math.max(height(x.left), height(x.right));
        // ^ Duas linhas adicionais para o IPL e height
        return x;
    }
    ...
    public static void main(String[] args) {
        BSTDeluxe<String, Integer> st = new BSTDeluxe<>();
